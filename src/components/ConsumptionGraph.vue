<template>
  <div class="w-full">
    <!-- TITLE -->
    <div class="w-full pb-[8px] border-b border-[#D2D2D2]">
    ...
    <div class="flex justify-between w-full mt-[16px]">
      ...
      <div class="flex items-center">
        ...
        >
          <mdicon name="arrow-left" size="40" class="text-primary-orange cursor-pointer" />
        </div>
        ...
        >
          <mdicon name="arrow-right" size="40" class="text-primary-orange cursor-pointer" />
        </div>
      </div>

      <!-- MONTH INFO -->
      <div class="flex flex-col items-end text-right">
        <p class="text-[0.875rem] font-bold text-lighten-blue">Mês de {{ getSelectedMonthText }}</p>
    ...
    <div class="flex flex-col">
      <div
        ...
        :key="unit"
        class="flex items-center justify-between py-[8px] text-[1rem] font-medium border-b border-[#D2D2D2]"
      >
...
onMounted(() => {
  // selectedConsumptionGraphMonth.value = homeStore.consumptionGraphMonths[0].month
})
</script>